...
Label(text='Базовая валюта').pack(padx=5, pady=5)
...
Label(text='Целевая валюта').pack(padx=5, pady=5)
...
Button(text='Получить курс обмена ', command=exchange).pack(pady=5, padx=5)
